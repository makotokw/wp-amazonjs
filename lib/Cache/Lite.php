...
define('AMAZONJS_CACHE_LITE_ERROR_RETURN', 1);
define('AMAZONJS_CACHE_LITE_ERROR_DIE', 8);

class Amazonjs_Cache_Lite
{
	 ...
	 * @access public
	 */
	function Amazonjs_Cache_Lite($options = array(NULL))
	{
	...
	function setToDebug()
	{
		$this->setOption('pearErrorMode', AMAZONJS_CACHE_LITE_ERROR_DIE);
	}
	...
	{
		return new WP_Error('amazonjs_cache_error', $msg, $code);
	}
